Shader "Unlit/AlwaysOnToon" {
    //show values to edit in inspector
    // Source: https://www.ronja-tutorials.com/post/032-improved-toon/
    Properties{
        ...
        SubShader{
            //the material is transparent at times 
            Tags{ "RenderType" = "Opaque" }

            
            
            Pass{
                 // Must use Lightmode for toggling pass (Really weird...) https://docs.unity3d.com/ScriptReference/Material.SetShaderPassEnabled.html
